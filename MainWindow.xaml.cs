...
namespace Butica_Andrei_Lab5
{
    ...
    public partial class MainWindow : Window
    {
        ...
        Binding purchaseDataDatePickerBinding = new Binding();
        ...
        public MainWindow()
        {
            ...
            //purchaseDataDatePickerBinding.Path = new PropertyPath("Purchase Data");
            ...
            //purchaseDataDatePicker.SetBinding(DatePicker.DisplayDateProperty, purchaseDataDatePickerBinding);
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            carViewSource.Source = ctx.Customers.Local;
            ctx.Customers.Load();
            ...
            if (action == ActionState.New)
            {
                try
                {
                    customer = new Customer()
                    {
                       ...
                       // PurchaseData = purchaseDataDatePicker;
                    };
                ...
                firstNameTextBox.SetBinding(TextBox.TextProperty, firstNameTextBoxBinding);
                lastNameTextBox.SetBinding(TextBox.TextProperty, lastNameTextBoxBinding);
                //purchaseDataDatePicker.SetBinding(DatePicker.SelectedDateProperty,
               //purchaseDataDatePickerBinding);
            }
            else if (action == ActionState.Edit)
            {
                try
                {
                    ...
                    //customer.PurchaseData = bodyStyleTextBox.Text.Trim();
                    ctx.SaveChanges();
                }
                catch (DataException ex)
                {
